...
from apps.users.storages.user_storage import validate_password, hash_password


class CustomLoginForm(LoginForm):
    """
    Customization of defauly Login form to support the User model
    from the Fast API applicatin and support password hashing that implemented there
    """
