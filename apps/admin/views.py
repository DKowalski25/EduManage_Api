...
class MyModelView(sqla.ModelView):
    """
    The overrired general Model View for SQLAlchemy models.
...
# Crutch for Flask Admin: excludes table and enum from being included in the list
# to view all models
# print(models)
right_models = []
for model in models:
    if isinstance(model, type(Base)):
